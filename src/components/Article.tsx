...
export default function Article({ articleUrl, title, category, description, author, date }: ArticleProps) {
    ...
    return (
        <div className="py-[5px] px-[15px] my-[10px] border-2 border-[#252525] rounded">
            ...
            <a href={articleUrl} className="font-heading1 font-medium text-2xl after:block after:content-[''] after:border-b-2 after:border-black after:scale-x-0 after:transition-transform after:duration-250 after:ease-in-out after:origin-[0%_50%] hover:after:scale-x-100">{title}</a>
